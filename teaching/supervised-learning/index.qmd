...
categories: [Disciplines, AI, Machine Learning, Supervised Learning, Statistics]
include-after-body:
  text: |
...
*   [**Lesson 1: Data, Distributions, and Anomaly Detection**](./aula01/index.qmd)
...
*   [**Lesson 2: Conditional Distributions and Generative Models**](./aula02/index.qmd)
    *   **ML Concept:** Multidimensional classification under the assumption of feature independence (Naive Bayes), and the general theory of statistical decision-making for K classes.
    *   **Statistical Concept:** Bayes' theorem decomposed into prior, likelihood, and posterior. The distinction between joint and conditional distributions, and the conditional independence assumption as a deliberate simplification to mitigate the curse of dimensionality. Formal decision theory — loss functions, posterior risk, and Bayes risk — as the general framework that recovers the binary cost-sensitive threshold of Lesson 1 as a special case.
    *   **Objectives:** Understand the generative approach to classification, the cost-benefit of independence assumptions in high dimensions, and decision-making as risk minimization rather than an ad-hoc rule.
    *   **Expected Competencies:** Ability to derive the Naive Bayes classifier from Bayes' theorem, explain when the independence assumption degrades — or fails to degrade — predictive performance, and formulate a general Bayes decision rule (including the rejection option) from an arbitrary loss matrix.

*   [**Lesson 3: Decision Trees — Greedy Partitioning**](./aula03/index.qmd)
...
*   [**Lesson 4: Model Selection and Resampling Techniques**](./aula04/index.qmd)
...
*   [**Lesson 5: Distribution, Likelihood, and Risk — The Common Thread of Lessons 1–4**](./aula05/index.qmd)
    *   **ML Concept:** Revisits Beta-density thresholding, Naive Bayes, CART, and cross-validation/Bootstrap as four instances of the same estimator, not four unrelated techniques.
    *   **Statistical Concept:** A single running example (Pima Indians Diabetes) carried through all four lenses, making explicit the shared machinery: an assumed distribution over the data, a likelihood used to fit it, and a decision grounded in risk (expected or estimated).
    *   **Objectives:** Consolidate the probabilistic vocabulary of Lessons 1–4 into one framework before Part 2's parametric, likelihood-driven models.
    *   **Expected Competencies:** Ability to recognize distribution → likelihood → decision as the common structure behind superficially distinct algorithms, and to trace one dataset's numbers correctly across all four techniques.

---

### Part 2: The Parametric Linear Story

*   [**Lesson 6: Linear Regression and Maximum Likelihood**](./aula06/index.qmd)
...
*   **Lesson 7: Logistic Regression and the GLM Framework**
...
*   **Lesson 8: Regularization and Bayesian MAP Estimation**
...
*   **Lesson 9: The Theoretical Bias-Variance Tradeoff**
...
*   **Lesson 10: Ensemble Theory and Variance Reduction**
    ...
    *   **Objectives:** Explain ensemble gains quantitatively through the variance term of the decomposition from Lesson 9.
...
*   **Lesson 11: Gradient Boosting and Numerical Optimization**
...
*   **Lesson 12: Support Vector Machines (SVM)**
...
*   **Lesson 13: Neural Networks and Representation Learning**
...
Core texts used throughout the course, cited by abbreviation in each lesson's materials (page- and equation-level citations are kept in that lesson's own source list):

*   Bishop, C. M. (2006). *Pattern Recognition and Machine Learning*. Springer. Referred to as **PRML**.
*   Bishop, C. M. & Bishop, H. (2024). *Deep Learning: Foundations and Concepts*. Springer. Referred to as **DLFC**.
