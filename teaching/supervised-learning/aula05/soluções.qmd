...
::: {.callout-tip}
## (Resposta) Teste 1 — Geometria da Projeção e Resíduos
...
::: {.callout-tip}
## (Resposta) Teste 2 — RSS, Equações Normais e Posto de X
...
::: {.callout-tip}
## (Resposta) Teste 3 — Premissas do Modelo Gaussiano Homocedástico
...
::: {.callout-tip}
## (Resposta) Teste 4 — Construção da Verossimilhança Conjunta
...
::: {.callout-tip}
## (Resposta) Teste 5 — O Teorema Central: OLS = MLE
...
::: {.callout-tip}
## (Resposta) Teste 6 — Viés do MLE de $\sigma^2$
...
::: {.callout-tip}
## (Resposta) Teste 7 — Verificação Numérica e Otimização
...
::: {.callout-tip}
## (Resposta) Teste 8 — Limitações: Heterocedasticidade, Censura e Não-Linearidade
