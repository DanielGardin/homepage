...
verossimilhança $\to$ decisão" que a Aula 5 revisou nas quatro primeiras
...
de três peças distribuição/verossimilhança/decisão (Aula 5, Bloco 5); o
...
## Plano de aula — Aula 6 (carga horária: ~125min)

1. **Abertura** (~15 min) — Revisão da Aula 5 (estrutura de três peças);
...
A Aula 5 usou *Pima Indians Diabetes* como fio condutor, mas seu alvo
...
aula como variável de entrada para um limiar de classificação (Aula 5,
