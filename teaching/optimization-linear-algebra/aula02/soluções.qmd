...
::: {.callout-tip}
## (Resposta) Teste 1 — A matriz de design
...
::: {.callout-tip}
## (Resposta) Teste 2 — Definição formal de matriz e produto matricial
...
::: {.callout-tip}
## (Resposta) Teste 3 — As duas leituras do produto matriz-vetor
...
::: {.callout-tip}
## (Resposta) Teste 4 — Regressão Linear Múltipla como sistema linear
...
::: {.callout-tip}
## (Resposta) Teste 5 — As três formas de solução de um sistema linear
...
::: {.callout-tip}
## (Resposta) Teste 6 — Sistemas homogêneos vs. não homogêneos
...
::: {.callout-tip}
## (Resposta) Teste 7 — Combinações lineares e independência
...
::: {.callout-tip}
## (Resposta) Teste 8 — Vetores em excesso e dependência forçada
...
::: {.callout-tip}
## (Resposta) Teste 9 — Multicolinearidade em atributos de um dataset
...
::: {.callout-tip}
## (Resposta) Teste 10 — Posto de uma matriz
...
::: {.callout-tip}
## (Resposta) Teste 11 — Posto e solvabilidade de sistemas lineares
...
::: {.callout-tip}
## (Resposta) Teste 12 — Multicolinearidade exata vs. quase-multicolinearidade
