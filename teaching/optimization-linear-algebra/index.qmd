...
categories: [Disciplines, Machine Learning, Optimization, Linear Algebra]
include-after-body:
  text: |
...
* [**Lesson 1: Vector Spaces, Norms, Inner Products, and Metrics**](./aula01/index.qmd)
...
* [**Lesson 2: Matrix Representations, Linear Systems, and Independence**](./aula02/index.qmd)
...
* [**Lesson 3: Orthogonal Projections and Subspaces**](./aula03/index.qmd)
...
* [**Lesson 4: Eigenvalues, Eigenvectors, and Symmetric Matrices**](./aula04/index.qmd)
...
* [**Lesson 5: Singular Value Decomposition (SVD) and Low-Rank Approximations**](./aula05/index.qmd)
...
* [**Lesson 6: Partial Derivatives, Jacobians, and Gradient Vectors**](./aula06/index.qmd)
...
Core text used in the lessons published so far, cited by abbreviation (page- and equation-level citations are kept in each lesson's own source list):

*   Deisenroth, M. P., Faisal, A. A. & Ong, C. S. (2024). *Mathematics for Machine Learning*. Freely available at [mml-book.com](https://mml-book.com). Referred to as **MathML**.

Reserved for the optimization-focused part of the course (Lessons 6+) and not yet cited in the lessons published so far:

*   Boyd, S. & Vandenberghe, L. (2004). *Convex Optimization*.
*   Wright, S. J. & Recht, B. (2022). *Optimization for Data Analysis*.
