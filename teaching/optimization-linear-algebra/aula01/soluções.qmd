...
::: {.callout-tip}
## (Resposta) Vetores de características e suas operações
...
::: {.callout-tip}
## (Resposta) Aprendizado supervisionado, a Hipótese de Suavidade e o $k$-NN
...
::: {.callout-tip}
## (Resposta) Subespaços vetoriais e o teste de fechamento
...
::: {.callout-tip}
## (Resposta) A Hipótese da Variedade (manifold) e sua relação com subespaços
...
::: {.callout-tip}
## (Resposta) Normas: $L_1$, $L_2$ e $L_\infty$
...
::: {.callout-tip}
## (Resposta) Definição formal de métrica e métrica induzida por norma
...
::: {.callout-tip}
## (Resposta) Distância Euclidiana e a maldição da dimensionalidade
...
::: {.callout-tip}
## (Resposta) Similaridade e Distância do Cosseno: métrica ou quase-métrica?
