...
::: {.callout-tip}
## (Resposta) Derivada parcial: definição e interpretação
...
::: {.callout-tip}
## (Resposta) O gradiente como vetor: convenção linha/coluna
...
::: {.callout-tip}
## (Resposta) Regras de derivação e o gradiente da perda quadrática
...
::: {.callout-tip}
## (Resposta) A direção de subida mais íngreme
...
::: {.callout-tip}
## (Resposta) O Jacobiano: definição e generalização
...
::: {.callout-tip}
## (Resposta) A regra da cadeia com Jacobiano
