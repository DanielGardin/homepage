...
::: {.callout-tip}
## (Resposta) Teste 1 — Autovalores e autovetores: a equação básica
...
::: {.callout-tip}
## (Resposta) Teste 2 — O polinômio característico
...
::: {.callout-tip}
## (Resposta) Teste 3 — Não-unicidade e autoespaços
...
::: {.callout-tip}
## (Resposta) Teste 4 — Teorema Espectral Real
...
::: {.callout-tip}
## (Resposta) Teste 5 — Definitude positiva
...
::: {.callout-tip}
## (Resposta) Teste 6 — Quociente de Rayleigh e número de condição
...
::: {.callout-tip}
## (Resposta) Teste 7 — $X^TX$: simetria e as duas faces desta aula
...
::: {.callout-tip}
## (Resposta) Teste 8 — Covariância empírica e a semente de PCA
