...
::: {.callout-tip}
## (Resposta) Sistemas sobredeterminados e a melhor aproximação
...
::: {.callout-tip}
## (Resposta) Subespaços e o complemento ortogonal
...
::: {.callout-tip}
## (Resposta) Definição formal de projeção

- ✔ Verdadeiro — Como $\pi$ mapeia $V$ sobre $U$ (é sobrejetora em $U$), todo $\mathbf{u}\in U$ é da forma $\mathbf{u}=\pi(\mathbf{v})$ para algum $\mathbf{v}\in V$. Aplicando $\pi$ novamente: $\pi(\mathbf{u})=\pi(\pi(\mathbf{v}))=\pi^2(\mathbf{v})=\pi(\mathbf{v})=\mathbf{u}$, usando exatamente a propriedade $\pi^2=\pi$ da definição de projeção (ver Convenções em `exercicios.qmd`).
...
::: {.callout-tip}
## (Resposta) Derivação das Equações Normais
...
::: {.callout-tip}
## (Resposta) Invertibilidade de $X^TX$ e a pseudo-inversa
...
::: {.callout-tip}
## (Resposta) Aplicação numérica e verificação de ortogonalidade
...
::: {.callout-tip}
## (Resposta) $R^2$ e o que a ortogonalidade do resíduo garante
...
::: {.callout-note icon=false}
## Posto e multicolinearidade exata
...
::: {.callout-tip}
## (Resposta) Posto e multicolinearidade exata
...
::: {.callout-note icon=false}
## Quase-multicolinearidade e número de condição
...
::: {.callout-tip}
## (Resposta) Quase-multicolinearidade e número de condição
...
::: {.callout-tip}
## (Resposta) A matriz de projeção $P_\pi$
...
::: {.callout-note icon=false}
## Síntese: da falta de solução ao número de condição
...
::: {.callout-tip}
## (Resposta) Síntese: da falta de solução ao número de condição
